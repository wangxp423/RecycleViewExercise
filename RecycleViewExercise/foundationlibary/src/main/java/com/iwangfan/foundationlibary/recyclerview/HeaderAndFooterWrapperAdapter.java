...
public class HeaderAndFooterWrapperAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    {
        WrapperAdapterUtils.onAttachedToRecyclerView(mInnerAdapter, recyclerView, new WrapperAdapterUtils.SpanSizeCallback()
        {
            @Override
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder)
    {
        ...
        {
            WrapperAdapterUtils.setFullSpan(holder);
        }
    }
