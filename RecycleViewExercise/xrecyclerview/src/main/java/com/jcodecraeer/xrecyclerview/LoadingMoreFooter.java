...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView() {
        ...
        mText.setText("正在努力加载");
        mText.setTextColor(Color.rgb(128,126,125));
    ...
    public void setProgressStyle(int style) {
        if (style == ProgressStyle.SysProgress) {
            final ProgressBar  progress=new ProgressBar(getContext(), null, android.R.attr.progressBarStyle);
